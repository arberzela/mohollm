...
# trials=60
# methods=("qLogEHVI" "EHVI")
# seeds=("42" "6790" "31415927" "1" "2" "3" "4" "5" "6" "7")

# problems=("chankong_haimes" "test_function_4" "schaffer_n1" "schaffer_n2" "poloni" "dtlz1" "dtlz2" "vehicle_safety" "toy_robust" "penicillin" "GMM" "car_side_impact" "branin_currin")
...
# Number of python processes to run in parallel.
