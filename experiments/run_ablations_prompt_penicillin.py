...
def main(seeds):
    ...
    base_config = {
        ...
        "warmstarting_prompt_template": "./prompt_templates/base/ablations/partitioning/warmstarting.txt",
        "candidate_sampler_prompt_template": "./prompt_templates/base/ablations/partitioning/candidate_sampler.txt",
        "surrogate_model_prompt_template": "./prompt_templates/base/ablations/partitioning/surrogate_model.txt",
        "metrics": ["F1", "F2", "F3"],
